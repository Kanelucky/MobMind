...
public class ExampleSheep extends IntelligentEntity implements Breedable, Feedable, Offspring {
    ...
    private BehaviorGroup buildBehaviorGroup() {
        EatGrassCallback eatSound = entity -> {
            ...
            entity.getInstance()
                  .playSound(Sound.sound(SoundEvent.ENTITY_SHEEP_STEP,
                                         Sound.Source.NEUTRAL,
                                         1f,
                                         1f), entity.getPosition());
        };
        ...
        return BehaviorGroup.builder()
                            ...
                            .behavior(BehaviorImpl.builder()
                                                  ...
                                                  .build())
                            .behavior(BehaviorImpl.builder()
                                                  .executor(Executors.eatGrass(
                                                          40,
                                                          eatSound))
                                                  .evaluator(Evaluators.probability(
                                                          1,
                                                          200))
                                                  .priority(2)
                                                  .period(40)
                                                  .build())
                            .behavior(Behaviors.weighted(Set.of(BehaviorImpl.builder()
                                                                            .executor(
                                                                                    Executors.idle(
                                                                                            20,
                                                                                            100))

...
public class BehaviorImpl implements Behavior {
    ...
    @Override
    public void onStart(EntityCreature entity) {
        executor.onStart(entity);
    }

    @Override
    public void onStop(EntityCreature entity) {
        executor.onStop(entity);
    }

    @Override
    public void onInterrupt(EntityCreature entity) {
    ...
    public static class Builder {
        ...
        public Builder executor(BehaviorExecutor e) {
            this.executor = e;
            return this;
        }

        public Builder evaluator(BehaviorEvaluator e) {
            this.evaluator = e;
            return this;
        }
        ...
        public BehaviorImpl build() {
            ...
            return new BehaviorImpl(executor,
                                    evaluator,
                                    priority,
                                    weight,
                                    period);

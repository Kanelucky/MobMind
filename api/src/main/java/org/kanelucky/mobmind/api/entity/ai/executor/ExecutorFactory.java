...
public interface ExecutorFactory {
    ...
    BehaviorExecutor shootProjectile(
            MemoryType<?> targetMemory,
            double speed,
            double normalSpeed,

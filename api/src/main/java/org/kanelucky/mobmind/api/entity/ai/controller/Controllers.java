...
public final class Controllers {
    ...
    public static void register(ControllerFactory f) {
        factory = f;
    }
    ...
    public static Controller walk() {
        return factory().createWalk();
    }

    public static Controller look() {
        return factory().createLook();
    }
}

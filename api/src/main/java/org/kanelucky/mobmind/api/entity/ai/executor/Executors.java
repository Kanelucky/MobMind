...
public final class Executors {
    ...
    public static void register(ExecutorFactory f) {
        factory = f;
    }
    ...
    public static BehaviorExecutor panic() {
        return factory().panic(0.15, 0.1, 8);
    }
    ...
    public static BehaviorExecutor idle() {
        return factory().idle(20, 60);
    }
    ...
    public static BehaviorExecutor roam() {
        return factory().roam(0.1, 0.1, 10, 20, true, 100, true, 10);
    }
    ...
    public static BehaviorExecutor roam(
            ...
            int maxRange,
            int frequency,
            boolean calNextImmediately,
            int runningTime,
            boolean avoidWater,
            int maxRetry
                                       ) {
        return factory().roam(speed,
                              normalSpeed,
                              maxRange,
                              frequency,
                              calNextImmediately,
    ...
    public static BehaviorExecutor followEntity(
        ...
        return factory().followEntity(memory,
                                      speed,
                                      normalSpeed,
                                      maxRangeSq,
                                      minRangeSq);
    ...
    public static BehaviorExecutor lookAtEntity(
            MemoryType<? extends Entity> memory,
            int duration
                                               ) {
    ...
    public static BehaviorExecutor lookAround() {
        return factory().lookAround(20, 60);
    }
    ...
    public static BehaviorExecutor wander() {
        return factory().wander(10.0);
    }

    public static BehaviorExecutor wander(double radius) {
        return factory().wander(radius);
    }

    public static BehaviorExecutor eatGrass() {
        return factory().eatGrass(40);
    }

    public static BehaviorExecutor eatGrass(int duration) {
        return factory().eatGrass(duration);
    }

    public static BehaviorExecutor eatGrass(
            int duration,
            EatGrassCallback callback
                                           ) {
        return factory().eatGrass(duration, callback);
    }

    public static BehaviorExecutor breeding() {
        return factory().breeding(60, 0.3, 0.1);
    }
    ...
    public static BehaviorExecutor moveToTarget(
            MemoryType<? extends net.minestom.server.coordinate.Point> memory,
            double speed,
            double normalSpeed,
            double maxRangeSq,
            double minRangeSq
                                               ) {
        return factory().moveToTarget(memory,
                                      speed,
                                      normalSpeed,
                                      maxRangeSq,
                                      minRangeSq);
    ...
    public static BehaviorExecutor meleeAttack(MemoryType<?> memory) {
        return factory().meleeAttack(memory,
                                     0.1,
                                     0.1,
                                     256.0,
                                     2.5,
    ...
    public static BehaviorExecutor meleeAttack(
            MemoryType<?> memory,
            double speed,
            double normalSpeed,
            double maxSenseRangeSq,
    ...
    public static BehaviorExecutor beamAttack(
        ...
        return factory().beamAttack(targetMemory,
                                    maxRangeSq,
                                    coolDownTick,
                                    attackDelay,
                                    clearDataWhenLose);
    ...
    public static BehaviorExecutor shootProjectile(
            MemoryType<?> targetMemory,
            ProjectileSupplier projectileSupplier
                                                  ) {
        return factory().shootProjectile(targetMemory,
                                         0.1,
                                         0.1,
                                         256.0,
                                         40,
    ...
    public static BehaviorExecutor jump(
            ...
            int jumpDelay,
            double jumpPower,
            double jumpPowerVariance
                                       ) {
        return factory().jump(jumpInterval,
                              jumpDelay,
                              jumpPower,
                              jumpPowerVariance);
    }
    ...
    public static BehaviorExecutor flee(
            MemoryType<?> targetMemory,
            double fleeSpeed,
            double normalSpeed,
            double minFleeRangeSq,
            double maxFleeRangeSq,
            int recalculateInterval
                                       ) {
        return factory().flee(targetMemory,
                              fleeSpeed,
                              normalSpeed,
                              minFleeRangeSq,
                              maxFleeRangeSq,
